...
else if($dopost=='save')
{
    ...
    $work_experience = htmlspecialchars_decode($_POST['work_experience']);
    $prize_good = htmlspecialchars_decode($_POST['prize_good']);
    //保存到主表
    $inQuery = "INSERT INTO `#@__archives`(id,typeid,sortrank,flag,ismake,channel,arcrank,click,money,title,shorttitle,
color,writer,source,litpic,pubdate,senddate,mid,description,keywords,mtype,sfz,qtzj,zgz,work_experience,prize_good)
VALUES ('$arcID','$typeid','$sortrank','$flag','$ismake','$channelid','$arcrank','0','$money','$title','$shorttitle',
'$color','$writer','$source','$litpic','$pubdate','$senddate','$mid','$description','$keywords','$mtypesid','$_POST[sfz]','$_POST[qtzj]','$_POST[zgz]','$work_experience','$prize_good'); ";
    //echo $inQuery;
    ...
    $addAid = $dsql->GetLastID();
	//更新教员的状态为审核教员
	$updateQuery = "UPDATE `#@__member` set spacesta=1 where mid=$mid";
    ...
    //返回成功信息
    ShowMsg("信息修改成功", "member/archives_edit.php?channelid=6&aid=" . $addAid,0,2000);
    $msg = "
    　　请选择你的后续操作：
