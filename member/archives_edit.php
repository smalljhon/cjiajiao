...
if(empty($dopost))
{
    ...
    {
        $dtime = time();
        $maxtime = $cfg_mb_editday * 999999999999999999999999999 *3600;
...
//echo $litpic;
    ...
    $upQuery = "UPDATE `#@__archives` SET
			 ...
			 qtzj='$_POST[qtzj]',
			 zgz='$_POST[zgz]' WHERE id='$aid' And mid='$mid'; ";
    ...
    $msg = "　　请选择你的后续操作：
        ...
        &nbsp;&nbsp;
        <a href='archives_edit.php?channelid=$channelid&aid=".$aid."'><u></u></a>
        &nbsp;&nbsp;
